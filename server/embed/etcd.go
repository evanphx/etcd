...
func StartEtcd(inCfg *Config) (e *Etcd, err error) {
	...
	srvcfg := config.ServerConfig{
		...
		PebbleMemTableBytes:               cfg.PebbleMemTableBytes,
		PebbleMemTableStopWritesThreshold: cfg.PebbleMemTableStopWritesThreshold,
		PebbleMaxOpenFiles:                cfg.PebbleMaxOpenFiles,
		PebbleMaxConcurrentCompactions:    cfg.PebbleMaxConcurrentCompactions,
...
func parseCompactionRetention(mode, retention string) (ret time.Duration, err error) {
	...
	if err == nil && h >= 0 {
		switch mode {
		case CompactorModeRevision, CompactorModeSize, CompactorModeAutoPeriodic:
