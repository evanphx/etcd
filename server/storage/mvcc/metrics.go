...
var (
	...
	dbLogicalSize = prometheus.NewGaugeFunc(
		prometheus.GaugeOpts{
			...
			Help:      "Logical size of the live keyspace in bytes: the sum of key+value bytes over all live keys, excluding revision history, tombstones, and storage-engine space amplification (bbolt freelist / Pebble compaction backlog).",
		},
		func() float64 {
